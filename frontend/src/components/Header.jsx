  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className='flex flex-wrap justify-center gap-5 mt-16'
        initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        >
            {
                ...
                .fill(' ')
                .map((item, index) => 
                ( <motion.img className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index%2 === 0 ? assets.sample_img_1 : assets.sample_img_2} key={index} width={70} 
        ...
        >Generate images form Gen image </motion.p>
    </motion.div>
  )
}
